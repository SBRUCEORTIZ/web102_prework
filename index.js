...
*/
  ...
  // STEP 2
    ...
    const unfundedGamesString = `${totalPledged.toLocaleString()} has been raised for ${totalGames} games. Currently,
     ${numUnfundedGames === 1 ? '1 game remains unfunded.' : `${numUnfundedGames} games remain unfunded.`}`;
